//go:generate mockgen -destination=rocket_mocks_test.go -package=rocket github.com/safciplak/go-grpc-microservices/internal/rocket Store

package rocket

import "context"

// Rocket - should contain the deniftion of our
// rocket
type Rocket struct {
	ID      string
	Name    string
